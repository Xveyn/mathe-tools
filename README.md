...
| [Vektorräume, lineare Abbildungen, Rang](formeln/vektorraeume-rang.html) | UVR-Kriterium, Elementzahl über GF(p), lineare Hüllen vergleichen, Abbildungsmatrix, Kern und Bild, Rang, Transponier-Regeln, die Äquivalenzkette der Regularität. |
...
**Vierzehn Themen, 152 Einträge — vollständig.** Alle vier Kapitel des
Stoffes sind abgedeckt: Integralrechnung (23 Einträge),
Differentialgleichungen (14), lineare Algebra (83) und Funktionen mehrerer
